...
export function OnboardingFlow({ onCreateSpace, onOpenFolder }: { onCreateSpace: () => void; onOpenFolder: () => void }) {
  return <main className="onboarding-flow">
    <section className="onboarding-choose">
      ...
      <div className="onboarding-copy"><span className="onboarding-kicker">{productName}</span><h1>Turn your work into a Space.</h1><p>A Space is an ordinary folder with everything around it—Chats, a reusable Library, History, Skills, and Extensions.</p></div>
