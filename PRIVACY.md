...
- Restricted-app install receipts, content-addressed package snapshots, per-automation enablement/cadence state and bounded run receipts, and Tenant-and-Data-Namespace-owned JSON storage under the application-data `restricted-apps` directory, plus separately encrypted restricted-app connections bound to their exact runtime and installation identities in `restricted-app-connections.bin`.
